...
class VGG19(object):
    ...
    def build_model(self, param_path='../../imagenet-vgg-verydeep-19.mat'):
        ...
        # conv5_2
        self.net.createConvLayer('conv5_2', input_shape5, 512, 3, 1, 1, 1)

        # relu5_2
        self.net.createReLuLayer('relu5_2')

        # conv5_3
        self.net.createConvLayer('conv5_3', input_shape5, 512, 3, 1, 1, 1)

        # relu5_3
        self.net.createReLuLayer('relu5_3')

        # conv5_4
        self.net.createConvLayer('conv5_4', input_shape5, 512, 3, 1, 1, 1)

        # relu5_4
        self.net.createReLuLayer('relu5_4')

        # pool5
        self.net.createPoolingLayer('pool5', input_shape5, 2, 2)
        ...
        input_shape6[1]=1
        input_shape6[2]=1
        input_shape6[3]=25088
        weight_shape6=pycnnl.IntVector(4)
        weight_shape6[0]=1
        weight_shape6[1]=1
        weight_shape6[2]=25088
        weight_shape6[3]=4096
        output_shape6=pycnnl.IntVector(4)
        output_shape6[0]=1
        output_shape6[1]=1
        output_shape6[2]=1
        output_shape6[3]=4096

        self.net.createMlpLayer('fc6', input_shape6,weight_shape6,output_shape6)
        ...
        input_shape7[2]=1
        input_shape7[3]=4096
        weight_shape7=pycnnl.IntVector(4)
        weight_shape7[0]=1
        weight_shape7[1]=1
        weight_shape7[2]=4096
        weight_shape7[3]=4096
        output_shape7=pycnnl.IntVector(4)
        output_shape7[0]=1
        output_shape7[1]=1
        output_shape7[2]=1
        output_shape7[3]=4096

        self.net.createMlpLayer('fc7', input_shape7,weight_shape7,output_shape7)
